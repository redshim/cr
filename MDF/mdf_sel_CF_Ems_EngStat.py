...
with open(filePath, 'r') as file:
    for line in file:
        ...
        if index == 0:
            ...
            column.append(fields.index('CF_Ems_EngStat'))
...
#hearder 부분 제거
        if index >= 2:
            ...
            CF_Ems_EngStat_Data.append(float(tempData[2]))
#시간정보
...
#print(tmp)
df = pd.DataFrame({'time':timeData, 'vtype' : vehicle_type_list, 'save_date' : save_date_list, 'CF_Ems_EngStat' : CF_Ems_EngStat_Data,'filename' : filename_list})
